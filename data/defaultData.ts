...
export const getDefaultKpiData = (): RepairKPI[] => [
    ...
    { id: 'kpi-175', category: 'หมวดไฟฟ้าคอนโทรลและระบบปรับอากาศ', item: 'หล่อขั้วแบตเตอรี่ ต่อ 1 อัน', standardHours: 1 },
    { id: 'kpi-176', category: 'หมวดไฟฟ้าคอนโทรลและระบบปรับอากาศ', item: 'ชาร์ตแบต เปลี่ยนขั้ว ต่อ 1 อัน', standardHours: 0.3 },
    { id: 'kpi-177', category: 'หมวดทั่วไป', item: 'บริการติดตั้งวิทยุสื่อสารพร้อมเดินสายไฟและสายอากาศ', standardHours: 2.5 },
    { id: 'kpi-178', category: 'หมวดทั่วไป', item: 'ติดตั้ง,ซ่อมขาถังดับเพลิง', standardHours: 1 },
    { id: 'kpi-179', category: 'หมวดทั่วไป', item: 'เปลี่ยน,ซ่อม มือล็อคหัวเก๋ง', standardHours: 1.5 },
    { id: 'kpi-180', category: 'หมวดทั่วไป', item: 'เปลี่ยน,ซ่อม มือดึงเบรตมือ', standardHours: 1 },
    { id: 'kpi-181', category: 'หมวดทั่วไป', item: 'เปลี่ยนบุ๊ชหัวเก๋งหน้า', standardHours: 4.5 },
    { id: 'kpi-182', category: 'หมวดทั่วไป', item: 'เปลี่ยนบุ๊ช-ยางรองหัวเก๋งด้านหลัง', standardHours: 1.8 },
    { id: 'kpi-183', category: 'หมวดทั่วไป', item: 'ติดตั้งเข็มขัดนิรภัย', standardHours: 2 },
    { id: 'kpi-184', category: 'หมวดทั่วไป', item: 'เปลี่ยนชุดซ่อมจานลาก', standardHours: 4.5 },
    { id: 'kpi-185', category: 'หมวดทั่วไป', item: 'ปรับตั้งจานลาก', standardHours: 0.5 },
    { id: 'kpi-186', category: 'หมวดทั่วไป', item: 'ใส่สปริงปากนกแก้ว', standardHours: 1 },
    { id: 'kpi-187', category: 'หมวดทั่วไป', item: 'เชื่อมแป้น ปรับ ซ่อม จานลาก', standardHours: 5 },
    { id: 'kpi-188', category: 'หมวดทั่วไป', item: 'เปลี่ยนแขนดึงแป้นจานลาก', standardHours: 1 },
    { id: 'kpi-189', category: 'หมวดทั่วไป', item: 'ซ่อมสะพานขึ้นจานลาก', standardHours: 3 },
    { id: 'kpi-190', category: 'หมวดทั่วไป', item: 'ติดตั้ง Jawbone', standardHours: 8 },
    { id: 'kpi-191', category: 'หมวดทั่วไป', item: 'ถอด-ซ่อม-ประกอบวาล์วเบรคหาง(สมอบก)', standardHours: 2 },
    { id: 'kpi-192', category: 'หมวดทั่วไป', item: 'ถอด-ซ่อม-ประกอบวาล์วรีเลย์เบรคหาง', standardHours: 2.5 },
    { id: 'kpi-193', category: 'หมวดทั่วไป', item: 'บริการสายไฟ,สายอากาศวิทยุสื่อสาร', standardHours: 1 },
    { id: 'kpi-194', category: 'หมวดทั่วไป', item: 'เปลี่ยนสายไมล์', standardHours: 1 },
    { id: 'kpi-195', category: 'หมวดทั่วไป', item: 'ซ่อม-ปรับเรือนไมล์', standardHours: 2 },
    { id: 'kpi-196', category: 'หมวดทั่วไป', item: 'เปลี่ยนสายคันเร่ง', standardHours: 1 },
    { id: 'kpi-197', category: 'หมวดทั่วไป', item: 'เปลี่ยนชุดแป้นเหยียบคันเร่ง', standardHours: 2 },
    { id: 'kpi-198', category: 'หมวดทั่วไป', item: 'เปลี่ยนชุดกลอนประตู ปรับตั้ง ต่อ 1 ข้าง', standardHours: 2.5 },
    { id: 'kpi-199', category: 'หมวดทั่วไป', item: 'เปลี่ยนชุดมอเตอร์กระจก', standardHours: 1.5 },
    { id: 'kpi-200', category: 'หมวดทั่วไป', item: 'เปลี่ยนเฟืองกระจกประตู ต่อ 1 ข้าง', standardHours: 2.5 },
    { id: 'kpi-201', category: 'หมวดทั่วไป', item: 'ถอด-ประกอบ-ปรับตั้งประตู ต่อ 1 ข้าง', standardHours: 3.5 },
    { id: 'kpi-202', category: 'หมวดทั่วไป', item: 'เปลี่ยนกระจกมองข้าง ต่อ 1 ข้าง', standardHours: 0.3 },
    { id: 'kpi-203', category: 'หมวดทั่วไป', item: 'ถอด-ประกอบพวงมาลัย', standardHours: 2 },
    { id: 'kpi-204', category: 'หมวดทั่วไป', item: 'ใส่น็อต ต่อ 1 จุด', standardHours: 0.1 },
    { id: 'kpi-205', category: 'หมวดทั่วไป', item: 'เชื่อมคอถัง เชื่อมถังน้ำมัน', standardHours: 2 },
    { id: 'kpi-206', category: 'หมวดทั่วไป', item: 'เปลี่ยนคอถังน้ำมัน', standardHours: 6 },
    { id: 'kpi-207', category: 'หมวดทั่วไป', item: 'เปลี่ยนถังน้ำมัน ดัดแปลง สายรัด ขาถัง', standardHours: 3 },
    { id: 'kpi-208', category: 'หมวดทั่วไป', item: 'ซ่อม,เปลี่ยนเข็มขัดรัดถัง', standardHours: 2.5 },
    { id: 'kpi-209', category: 'หมวดทั่วไป', item: 'เปลี่ยนขาถังน้ำมัน', standardHours: 4 },
    { id: 'kpi-210', category: 'หมวดทั่วไป', item: 'เปลี่ยนท่อน้ำมันโซล่า', standardHours: 1 },
    { id: 'kpi-211', category: 'หมวดทั่วไป', item: 'ย้ายท่อน้ำมันพร้อมคลอบลูกลอยน้ำมัน', standardHours: 4 },
    { id: 'kpi-212', category: 'หมวดทั่วไป', item: 'ล้างถังน้ำมันพร้อมทำความสะอาดท่อน้ำมัน', standardHours: 5 },
    { id: 'kpi-213', category: 'หมวดทั่วไป', item: 'ซ่อมกรอบป้ายทะเบียน', standardHours: 1 },
    { id: 'kpi-214', category: 'หมวดทั่วไป', item: 'ซ่อมสายลม ตัด ต่อ ต่อ 1 จุด', standardHours: 0.3 },
    { id: 'kpi-215', category: 'หมวดทั่วไป', item: 'ซ่อมขาเบาะ ต่อ 1 ข้าง', standardHours: 2 },
    { id: 'kpi-216', category: 'หมวดทั่วไป', item: 'ถอด-ประกอบเบาะส่งซ่อม', standardHours: 3 },
    { id: 'kpi-217', category: 'หมวดทั่วไป', item: 'ซ่อมบังโคลน ต่อ 1 ข้าง', standardHours: 1 },
    { id: 'kpi-218', category: 'หมวดทั่วไป', item: 'เปลี่ยนขาบังโคลนหลัง ต่อ 1 ข้าง', standardHours: 1.5 },
    { id: 'kpi-219', category: 'หมวดทั่วไป', item: 'เปลี่ยนยางบังฝุ่น ต่อ 1 ข้าง', standardHours: 0.2 },
    { id: 'kpi-220', category: 'หมวดทั่วไป', item: 'เชื่อมโครงเหล็กกระบังลมหลังคา', standardHours: 1 },
    { id: 'kpi-221', category: 'หมวดทั่วไป', item: 'เปลี่ยนกระจกกลมส่องหน้ารถ ต่อ 1 ข้าง', standardHours: 0.5 },
    { id: 'kpi-222', category: 'หมวดทั่วไป', item: 'ตรวจซ่อมระบบวาล์วลม ลมรั่ว', standardHours: 2 },
    { id: 'kpi-223', category: 'หมวดทั่วไป', item: 'ซ่อมขาค้ำยัน ต่อ 1 ข้าง', standardHours: 1.5 },
    { id: 'kpi-224', category: 'หมวดทั่วไป', item: 'ซ่อม เปลี่ยนใบปัดน้ำฝน', standardHours: 0.3 },
    { id: 'kpi-225', category: 'หมวดทั่วไป', item: 'ซ่อม เปลี่ยนสายยาง,มอเตอร์น้ำล้างกระจก', standardHours: 1.25 },
    { id: 'kpi-226', category: 'หมวดทั่วไป', item: 'ซ่อม เชื่อม ราวกันชนหาง ต่อ 1 ข้าง', standardHours: 1 },
    { id: 'kpi-227', category: 'หมวดทั่วไป', item: 'ซ่อม เชื่อม อุปกรณ์ต่างๆ', standardHours: 1.25 },
    { id: 'kpi-228', category: 'หมวดทั่วไป', item: 'เปลี่ยนใบปัดน้ำฝน', standardHours: 0.1 },
    { id: 'kpi-229', category: 'หมวดทั่วไป', item: 'เปลี่ยนแผ่นป้ายทะเบียน', standardHours: 0.5 },
    { id: 'kpi-230', category: 'หมวดทั่วไป', item: 'เชื่อมกันชนหน้า', standardHours: 1 },
    { id: 'kpi-231', category: 'หมวดทั่วไป', item: 'เช็คสายคันเร่ง', standardHours: 1 },
    { id: 'kpi-232', category: 'หมวดระบบก๊าซNGV', item: 'บริการระบบควบคุมการจ่ายแก๊ส NGV', standardHours: 6.75 },
    { id: 'kpi-233', category: 'หมวดระบบก๊าซNGV', item: 'เปลี่ยนท่อแก๊ส NGV 1 จุด', standardHours: 1.5 },
    { id: 'kpi-234', category: 'หมวดระบบก๊าซNGV', item: 'ถอดเปลี่ยนหัวเติมแก๊ส 1 จุด', standardHours: 1.125 },
    { id: 'kpi-235', category: 'หมวดระบบก๊าซNGV', item: 'ถอดเปลี่ยนเรกกูเรเตอร์ (หม้อต้มแก๊ส) ต่อ 1 ชุด', standardHours: 6 },
    { id: 'kpi-236', category: 'หมวดระบบก๊าซNGV', item: 'ถอด-ประกอบถังแก๊ส', standardHours: 12 },
    { id: 'kpi-237', category: 'หมวดระบบก๊าซNGV', item: 'ถอดเปลียนแรคยึดถังแก๊ส', standardHours: 12 },
    { id: 'kpi-238', category: 'หมวดระบบก๊าซNGV', item: 'ถอดเปลี่ยนท่อแก๊ส NGV (1 จุด)', standardHours: 2.625 },
    { id: 'kpi-239', category: 'หมวดระบบก๊าซNGV', item: 'จูนแก๊ส NGV', standardHours: 3 },
    { id: 'kpi-240', category: 'หมวดระบบก๊าซNGV', item: 'เชื่อมฐานโครงแก๊ส ต่อ 1 จุด', standardHours: 0.5 },
    { id: 'kpi-241', category: 'หมวดแท็งค์เคมี', item: 'ถอด ประกอบ ซ่อม เกียร์ปั๊ม', standardHours: 10 },
    { id: 'kpi-242', category: 'หมวดแท็งค์เคมี', item: 'เปลี่ยนประเก็นฝาแท็งค์ ต่อ 1 จุด', standardHours: 2 },
    { id: 'kpi-243', category: 'หมวดแท็งค์เคมี', item: 'เปลี่ยน,ซ่อมวาล์วก้นแทงค์,บนแทงค์', standardHours: 2 },
    { id: 'kpi-244', category: 'หมวดแท็งค์เคมี', item: 'เปลี่ยนวาล์วลดแรงดันลม', standardHours: 2 },
    { id: 'kpi-245', category: 'หมวดแท็งค์เคมี', item: 'เปลี่ยนหน้าแปลนท่อเคมี 1 จุด', standardHours: 1.25 },
    { id: 'kpi-246', category: 'หมวดแท็งค์เคมี', item: 'เปลี่ยนท่อลงเคมี', standardHours: 3 },
    { id: 'kpi-247', category: 'หมวดแท็งค์เคมี', item: 'เปลี่ยนซีลปั๊มเคมี', standardHours: 3 },
    { id: 'kpi-248', category: 'หมวดแท็งค์เคมี', item: 'เปลี่ยนกากบาทเพลาปั่นปั๊ม 1 จุด', standardHours: 1.5 },
    { id: 'kpi-249', category: 'หมวดแท็งค์เคมี', item: 'เปลี่ยนเพลาปั่นปั๊ม', standardHours: 1 },
    { id: 'kpi-250', category: 'หมวดแท็งค์เคมี', item: 'เปลี่ยนประเก็น,บอลวาล์ว,หัวดรายเบรค', standardHours: 3 },
    { id: 'kpi-251', category: 'หมวดรถยกหนัก', item: 'เปลี่ยนยาง(Top Lifter)', standardHours: 5 },
    { id: 'kpi-252', category: 'หมวดรถยกหนัก', item: 'เปลี่ยนสายคอนโทรลไฮดรอลิคคอนโทรลวาล์ว', standardHours: 3.5 },
    { id: 'kpi-253', category: 'หมวดรถยกหนัก', item: 'ซ่อมระบบไฟล็อค ปลดล็อค Sensor ครอบตู้(Top)', standardHours: 2 },
    { id: 'kpi-254', category: 'หมวดรถยกหนัก', item: 'เชื่อมฐานแขนระบบไฮดรอลิค(Top)', standardHours: 5 },
    { id: 'kpi-255', category: 'หมวดรถยกหนัก', item: 'เชื่อมข้อต่อไฮดรอลิค(Top)', standardHours: 1 },
    { id: 'kpi-256', category: 'หมวดรถยกหนัก', item: 'ระบบไฟคอนโทรลสเปรดเดอร์ Toplifter', standardHours: 8 },
    { id: 'kpi-257', category: 'หมวดรถยกหนัก', item: 'เปลี่ยนแตรลมไฟฟ้า(Top Lifter)', standardHours: 1 },
    { id: 'kpi-258', category: 'หมวดรถยกหนัก', item: 'น็อตดุมล้อ,เปลี่ยนกะทะ, โอริงกะทะล้อ,ต่อแกนจุ๊บเติมลมยาง', standardHours: 8 },
    { id: 'kpi-259', category: 'หมวดรถยกหนัก', item: 'เปลี่ยนน็อตประกับบูชสเปดเดอรร์(Top)', standardHours: 2.4 },
    { id: 'kpi-260', category: 'หมวดรถยกหนัก', item: 'เติมน้ำมันไฮดรอลิค(Top)', standardHours: 1 },
    { id: 'kpi-261', category: 'หมวดรถยกหนัก', item: 'เช็คระบบท่อน้ำ (Top)', standardHours: 2 },
    { id: 'kpi-262', category: 'หมวดรถยกหนัก', item: 'เปลี่ยนสลักแขนโยกเลี้ยว (Top)', standardHours: 2 },
    { id: 'kpi-263', category: 'หมวดรถยกหนัก', item: 'เปลี่ยนหน้าแปลนแป๊บข้องอชุดยืดหด(Top)', standardHours: 2.5 },
    { id: 'kpi-264', category: 'หมวดรถยกหนัก', item: 'เปลี่ยนสายไฮดรอลิคขึ้นสเปรดเดอร์(Top)', standardHours: 8 },
    { id: 'kpi-265', category: 'หมวดรถยกหนัก', item: 'เปลี่ยนสายไฮดรอลิคทั่วไป(Top)', standardHours: 4 },
    { id: 'kpi-266', category: 'หมวดรถยกหนัก', item: 'เปลี่ยนซีลกระบอกไฮดรอลิค(Top)', standardHours: 5 },
    { id: 'kpi-267', category: 'หมวดรถยกหนัก', item: 'เปลี่ยนซีลกระบอกไฮดรอลิคเสายกบูม(Top)', standardHours: 22 },
    { id: 'kpi-268', category: 'หมวดรถยกหนัก', item: 'เปลี่ยนโอริง ท่อไฮดรอลิค ชุดยืดหดสเปดเดอร์(Top)', standardHours: 2 },
    { id: 'kpi-269', category: 'หมวดรถยกหนัก', item: 'ซ่อมโซ่ระบบยืด 20-40', standardHours: 2 },
    { id: 'kpi-270', category: 'หมวดรถยกหนัก', item: 'เปลี่ยนโซ่ระบบยืด 20-40', standardHours: 16 },
    { id: 'kpi-271', category: 'หมวดรถยกหนัก', item: 'ซ่อมรางโซ่ระบบยืด 20-40', standardHours: 4 },
    { id: 'kpi-272', category: 'หมวดรถยกหนัก', item: 'ซ่อมระบบไฟฟ้ายืด 20-40', standardHours: 4 },
    { id: 'kpi-273', category: 'หมวดรถยกหนัก', item: 'ซ่อม-เปลี่ยนทวิสล็อค 1 ข้าง', standardHours: 7.5 },
    { id: 'kpi-274', category: 'หมวดรถยกหนัก', item: 'ซ่อมตัว Sensor สเปดเดอร์(TOP)', standardHours: 3 },
    { id: 'kpi-275', category: 'หมวดรถยกหนัก', item: 'ซ่อมAlternator ไดชาร์จ (TOP)', standardHours: 8 },
    { id: 'kpi-276', category: 'หมวดรถยกหนัก', item: 'ซ่อมมอเตอร์สตาร์ท (TOP)', standardHours: 8 },
    { id: 'kpi-277', category: 'หมวดPM', item: 'PM ชุด A (15,000 KMS.)', standardHours: 2.35 },
    { id: 'kpi-278', category: 'หมวดPM', item: 'PM Step250 Hrs. Toplifter', standardHours: 3 },
    { id: 'kpi-279', category: 'หมวดPM', item: 'PM ชุด B ( 30,000 KMS.)', standardHours: 6 },
    { id: 'kpi-280', category: 'หมวดPM', item: 'PM Step 500 Hrs. Toplifter', standardHours: 6 },
    { id: 'kpi-281', category: 'หมวดPM', item: 'PM ชุด C (90,000 KMS.)', standardHours: 12 },
    { id: 'kpi-282', category: 'หมวดPM', item: 'PM Step 1000 Hrs. Toplifter', standardHours: 12 },
    { id: 'kpi-283', category: 'หมวดPM', item: 'PM Step 2000 Hrs. Toplifter', standardHours: 12 },
    { id: 'kpi-284', category: 'หมวดPM', item: 'เติมน้ำมันเครื่อง', standardHours: 0.1 },
    { id: 'kpi-285', category: 'หมวดPM', item: 'เปลี่ยนน้ำมันเครื่อง', standardHours: 0.75 },
    { id: 'kpi-286', category: 'หมวดPM', item: 'เปลี่ยนไส้กรองเครื่อง', standardHours: 0.6 },
    { id: 'kpi-287', category: 'หมวดPM', item: 'เปลี่ยนไส้กรองเชื้อเพลิง', standardHours: 0.6 },
    { id: 'kpi-288', category: 'หมวดPM', item: 'เปลี่ยน-เป๋าใส้กรองอากาศ Top Lifter', standardHours: 1 },
    { id: 'kpi-289', category: 'หมวดPM', item: 'เปลี่ยนหัวเทียน', standardHours: 1 },
    { id: 'kpi-290', category: 'หมวดPM', item: 'เปลี่ยนน้ำมันเกียร์/เฟืองท้าย', standardHours: 1.5 },
    { id: 'kpi-291', category: 'หมวดPM', item: 'เปลี่ยนไส้กรองเฟืองท้าย', standardHours: 0.45 },
    { id: 'kpi-292', category: 'หมวดPM', item: 'เปลี่ยนน้ำมันพาวเวอร์', standardHours: 1.5 },
    { id: 'kpi-293', category: 'หมวดPM', item: 'เปลี่ยน,ทำความสะอาดใส้กรองอากาศ', standardHours: 0.4 },
    { id: 'kpi-294', category: 'หมวดPM', item: 'เปลี่ยนไส้กรองพาวเวอร์', standardHours: 0.4 },
    { id: 'kpi-295', category: 'หมวดPM', item: 'อัดจารบี 1 คัน (รถใหญ่)', standardHours: 1 },
    { id: 'kpi-296', category: 'หมวดPM', item: 'อัดจารบี 1 คัน (หาง)', standardHours: 0.2 },
    { id: 'kpi-297', category: 'หมวดPM', item: 'เปลี่ยนหัวอัดอัดจารบี 1 จุด', standardHours: 0.15 },
    { id: 'kpi-298', category: 'หมวดPM', item: 'ตรวจเช็ควาล์ว', standardHours: 3.3 },
    { id: 'kpi-299', category: 'หมวดPM', item: 'ตรวจเช็คระบบเบรค', standardHours: 1.8 },
    { id: 'kpi-300', category: 'หมวดPM', item: 'ตรวจเช็คระบบคลัทช์', standardHours: 0.9 },
    { id: 'kpi-301', category: 'หมวดPM', item: 'เปลี่ยนน้ำมันเบรค พร้อมไล่ลมน้ำมันเบรค', standardHours: 2.7 },
    { id: 'kpi-302', category: 'หมวดPM', item: 'เปลี่ยนสารดูดความชื้น', standardHours: 3 },
    { id: 'kpi-303', category: 'หมวดPM', item: 'เปลี่ยนน้ำมันคลัทช์', standardHours: 1.5 },
    { id: 'kpi-304', category: 'หมวดPM', item: 'เปลี่ยนจารบีลูกปืนล้อ ต่อ 1 ล้อ', standardHours: 3.5 },
    { id: 'kpi-305', category: 'หมวดPM', item: 'เปลี่ยนสายพานเครื่อง', standardHours: 0.5 },
    { id: 'kpi-306', category: 'หมวดหางลาก', item: 'เต้าแหนบหน้า', standardHours: 6 },
    { id: 'kpi-307', category: 'หมวดหางลาก', item: 'เต้าแหนบกลาง', standardHours: 6 },
    { id: 'kpi-308', category: 'หมวดหางลาก', item: 'เต้าแหนบหลัง', standardHours: 6 },
    { id: 'kpi-309', category: 'หมวดหางลาก', item: 'หมอนรองแหนบเพลากลม 127 mm', standardHours: 4.5 },
    { id: 'kpi-310', category: 'หมวดหางลาก', item: 'ฝาครอบแหนบเพลากลม 127 mm', standardHours: 3 },
    { id: 'kpi-311', category: 'หมวดหางลาก', item: 'เสื้อลูกหมากปรับได้ครบชุด', standardHours: 1.5 },
    { id: 'kpi-312', category: 'หมวดหางลาก', item: 'เฉพาะเสื้อลูกหมากปรับได้', standardHours: 3 },
    { id: 'kpi-313', category: 'หมวดหางลาก', item: 'เฉพาะแกนกลางเสื้อลูกหมากปรับได้', standardHours: 3 },
    { id: 'kpi-314', category: 'หมวดหางลาก', item: 'เสื้อลูกหมากตัวตาย (ครบชุด)', standardHours: 3 },
    { id: 'kpi-315', category: 'หมวดหางลาก', item: 'เฉพาะเสื้อลูกหมากตัวตาย', standardHours: 3 },
    { id: 'kpi-316', category: 'หมวดหางลาก', item: 'ลูกหมากแบบซุปเปอร์', standardHours: 3 },
    { id: 'kpi-317', category: 'หมวดหางลาก', item: 'สกูรร้อยลูกหมาก+แหวน+น็อต', standardHours: 1.5 },
    { id: 'kpi-318', category: 'หมวดหางลาก', item: 'สลักแขนลากครบชุด ขนาด 3/8 mm', standardHours: 1.5 },
    { id: 'kpi-319', category: 'หมวดหางลาก', item: 'สลักแขนลากขนาด 3/8 mm', standardHours: 1.5 },
    { id: 'kpi-320', category: 'หมวดหางลาก', item: 'น็อตสลักแขนลาก', standardHours: 1.5 },
    { id: 'kpi-321', category: 'หมวดหางลาก', item: 'บูชแขนลาก', standardHours: 1.5 },
    { id: 'kpi-322', category: 'หมวดหางลาก', item: 'แหวนรองสลักแขนลาก', standardHours: 0.75 },
    { id: 'kpi-323', category: 'หมวดหางลาก', item: 'แขนยึดปรับได้ (ครบชุด)', standardHours: 1.5 },
    { id: 'kpi-324', category: 'หมวดหางลาก', item: 'แขนยึดปรับได้ + สกูร', standardHours: 1.5 },
    { id: 'kpi-325', category: 'หมวดหางลาก', item: 'แกนเกลียวแขนยึดปรับได้', standardHours: 1.5 },
    { id: 'kpi-326', category: 'หมวดหางลาก', item: 'แขนยึดตัวตาย', standardHours: 1.5 },
    { id: 'kpi-327', category: 'หมวดหางลาก', item: 'สลักแขนยึดครบชุด', standardHours: 1.5 },
    { id: 'kpi-328', category: 'หมวดหางลาก', item: 'สลักแขนยึด', standardHours: 1.5 },
    { id: 'kpi-329', category: 'หมวดหางลาก', item: 'แหวน + น็อตสลักแขนยึด', standardHours: 0.75 },
    { id: 'kpi-330', category: 'หมวดหางลาก', item: 'สลักโตงเตงกลางครบชุด', standardHours: 3 },
    { id: 'kpi-331', category: 'หมวดหางลาก', item: 'สลักโตงเตงกลาง', standardHours: 3 },
    { id: 'kpi-332', category: 'หมวดหางลาก', item: 'แหวนสลักโตงเตงกลาง', standardHours: 1.5 },
    { id: 'kpi-333', category: 'หมวดหางลาก', item: 'น็อตสลักโตงเตงกลาง', standardHours: 3 },
    { id: 'kpi-334', category: 'หมวดหางลาก', item: 'หมอนโตงเตงกลาง (รุ่นบูชทองเหลือง)', standardHours: 12 },
    { id: 'kpi-335', category: 'หมวดหางลาก', item: 'บูชโตงเตงกลาง (แหนบ 3” 4”)', standardHours: 6 },
    { id: 'kpi-336', category: 'หมวดหางลาก', item: 'บูชแขนยึด', standardHours: 1.5 },
    { id: 'kpi-337', category: 'หมวดหางลาก', item: 'โตงเตงกลาง', standardHours: 6 },
    { id: 'kpi-338', category: 'หมวดหางลาก', item: 'ฝาประกับแหนบ', standardHours: 3 },
    { id: 'kpi-339', category: 'หมวดหางลาก', item: 'หมอนรองเพลา', standardHours: 4.5 },
    { id: 'kpi-340', category: 'หมวดหางลาก', item: 'สาแหรกแหนบ', standardHours: 3 },
    { id: 'kpi-341', category: 'หมวดหางลาก', item: 'ลูกหมาก (ธรรมดา)', standardHours: 1.5 },
    { id: 'kpi-342', category: 'หมวดหางลาก', item: 'ลูกหมาก (ซุปเปอร์)', standardHours: 1.5 },
    { id: 'kpi-343', category: 'หมวดหางลาก', item: 'แหนบ', standardHours: 3 },
    { id: 'kpi-344', category: 'หมวดหางลาก', item: 'หม้อลมเบรคชั้นเดียว', standardHours: 1.5 },
    { id: 'kpi-345', category: 'หมวดหางลาก', item: 'หม้อลมเบรค 2 ชั้น', standardHours: 1.5 },
    { id: 'kpi-346', category: 'หมวดหางลาก', item: 'ยางหม้อลมเบรคขนาด 7", 8"', standardHours: 1.5 },
    { id: 'kpi-347', category: 'หมวดหางลาก', item: 'มือเสือ เหลือง – แดง', standardHours: 0.75 },
    { id: 'kpi-348', category: 'หมวดหางลาก', item: 'ลูกยางมือเสือ', standardHours: 0.75 },
    { id: 'kpi-349', category: 'หมวดหางลาก', item: 'คิงพิน 2” (Marky)', standardHours: 12 },
    { id: 'kpi-350', category: 'หมวดหางลาก', item: 'ขาค้ำยัน (Binkly) 1 ข้าง', standardHours: 6 },
    { id: 'kpi-351', category: 'หมวดหางลาก', item: 'ทวิชลีอก ทั้งชุด', standardHours: 6 },
    { id: 'kpi-352', category: 'หมวดหางลาก', item: 'ทวิชล็อก เฉพาะแกน', standardHours: 1.5 },
    { id: 'kpi-353', category: 'หมวดหางลาก', item: 'ทวิชล็อก เฉพาะเสื้อ', standardHours: 6 },
    { id: 'kpi-354', category: 'หมวดหางลาก', item: 'เข็มขัดรัดสายลมยาง', standardHours: 0.75 },
    { id: 'kpi-355', category: 'หมวดหางลาก', item: 'สายลมยางขนาด 3/8', standardHours: 1.5 },
    { id: 'kpi-356', category: 'หมวดหางลาก', item: 'ลูกยางร้อยสายลมไนล่อน', standardHours: 0.75 },
    { id: 'kpi-357', category: 'หมวดหางลาก', item: 'เหล็กประกันแป๊ปเดินลม (เก่า)', standardHours: 1.5 },
    { id: 'kpi-358', category: 'หมวดหางลาก', item: 'เหล็กประกันแป๊ปเดินลม ( ใหม่ )', standardHours: 1.5 },
    { id: 'kpi-359', category: 'หมวดหางลาก', item: 'ข้อต่อมือเสือ', standardHours: 0.75 },
    { id: 'kpi-360', category: 'หมวดหางลาก', item: 'ข้อต่อในบูม', standardHours: 0.75 },
    { id: 'kpi-361', category: 'หมวดหางลาก', item: 'ปลั๊กไฟ 7 สาย', standardHours: 3 },
    { id: 'kpi-362', category: 'หมวดหางลาก', item: 'เต้าเสียบ 7 สาย', standardHours: 1.5 },
    { id: 'kpi-363', category: 'หมวดหางลาก', item: 'สายไฟคอยสปริง 7 สาย', standardHours: 1.5 },
    { id: 'kpi-364', category: 'หมวดหางลาก', item: 'สายไฟ 7 สาย 7 สี', standardHours: 3 },
    { id: 'kpi-365', category: 'หมวดหางลาก', item: 'ลูกยางร้อยสายไฟ', standardHours: 1.5 },
    { id: 'kpi-366', category: 'หมวดหางลาก', item: 'ซีลเหล็ก', standardHours: 3 },
    { id: 'kpi-367', category: 'หมวดหางลาก', item: 'ซีลกันฝุ่น', standardHours: 6 },
    { id: 'kpi-368', category: 'หมวดหางลาก', item: 'ฝาครอบหัวเพลา', standardHours: 0.75 },
    { id: 'kpi-369', category: 'หมวดหางลาก', item: 'ไฟท้าย', standardHours: 1.5 },
    { id: 'kpi-370', category: 'หมวดหางลาก', item: 'ฝาครอบไฟ (JCM )', standardHours: 0.25 },
    { id: 'kpi-371', category: 'หมวดหางลาก', item: 'ไฟส่องป้าย', standardHours: 0.75 },
    { id: 'kpi-372', category: 'หมวดหางลาก', item: 'ไฟถอย', standardHours: 0.75 },
    { id: 'kpi-373', category: 'หมวดหางลาก', item: 'ไฟข้างวอลโว่', standardHours: 1.5 },
    { id: 'kpi-374', category: 'หมวดหางลาก', item: 'ไฟข้างมิดเวย์ (สต๊อบแลมป์ )', standardHours: 1.5 },
    { id: 'kpi-375', category: 'หมวดหางลาก', item: 'ฝาครอบไฟข้างมิดเวย์', standardHours: 0.75 },
    { id: 'kpi-376', category: 'หมวดหางลาก', item: 'สปริงดึงสายไฟหางเทรนเลอร์', standardHours: 1.5 },
    { id: 'kpi-377', category: 'หมวดหางลาก', item: 'สปริงดึงหม้อลมเบรก', standardHours: 0.75 },
    { id: 'kpi-378', category: 'หมวดหางลาก', item: 'ผ้าเบรก', standardHours: 6 },
    { id: 'kpi-379', category: 'หมวดหางลาก', item: 'สติ๊กเกอร์ รูปรถพ่วง', standardHours: 0.75 },
    { id: 'kpi-380', category: 'หมวดหางลาก', item: 'สติ๊กเกอร์ รถพ่วง', standardHours: 0.75 },
    { id: 'kpi-381', category: 'หมวดหางลาก', item: 'เปลี่ยนตัวตั้งเบรก', standardHours: 1.5 },
    { id: 'kpi-382', category: 'หมวดหางลาก', item: 'เปลี่ยนยางใน – ปะยาง 1 เส้น', standardHours: 0.4 },
    { id: 'kpi-383', category: 'หมวดหางลาก', item: 'สลับยาง 1 เส้น', standardHours: 0.2 },
    { id: 'kpi-384', category: 'หมวดหางลาก', item: 'เปลี่ยนหน้าแปลนขาค้ำยัน', standardHours: 12 },
    { id: 'kpi-385', category: 'หมวดหางลาก', item: 'เปลี่ยนตีนช้าง', standardHours: 1.5 },
    { id: 'kpi-386', category: 'หมวดหางลาก', item: 'เปลี่ยนตัวหมุนขาค้ำยัน', standardHours: 1.5 },
    { id: 'kpi-387', category: 'หมวดหางลาก', item: 'เปลี่ยนไซด์การ์ด R-L', standardHours: 6 },
    { id: 'kpi-388', category: 'หมวดหางลาก', item: 'ตัดต่อไซด์การ์ด R-L', standardHours: 3 },
    { id: 'kpi-389', category: 'หมวดหางลาก', item: 'เปลี่ยนหน้าแปลนไซด์การ์ด', standardHours: 3 },
    { id: 'kpi-390', category: 'หมวดหางลาก', item: 'เปลี่ยนแผงกันชนหลัง', standardHours: 6 },
    { id: 'kpi-391', category: 'หมวดหางลาก', item: 'เปลี่ยนกรอบไฟท้าย R-L', standardHours: 3 },
    { id: 'kpi-392', category: 'หมวดหางลาก', item: 'เปลี่ยนจารบีล้อ', standardHours: 3 },
    { id: 'kpi-393', category: 'หมวดหางลาก', item: 'เปลี่ยนบัวรับตู้', standardHours: 4.5 },
    { id: 'kpi-394', category: 'หมวดหางลาก', item: 'เปลี่ยนบังโคลน R-L', standardHours: 6 },
    { id: 'kpi-395', category: 'หมวดหางลาก', item: 'เปลี่ยนขาบังโคลน R-L', standardHours: 3 },
    { id: 'kpi-396', category: 'หมวดหางลาก', item: 'เปลี่ยนหน้าแปลนขาบังโคลน R-L', standardHours: 6 },
    { id: 'kpi-397', category: 'หมวดหางลาก', item: 'เชื่อมบังโคลน R-L', standardHours: 1.5 },
    { id: 'kpi-398', category: 'หมวดหางลาก', item: 'ตัดต่อขาบังโคลน R-L', standardHours: 3 },
    { id: 'kpi-399', category: 'หมวดหางลาก', item: 'เปลี่ยนพิงฝุ่น R-L', standardHours: 1.5 },
    { id: 'kpi-400', category: 'หมวดหางลาก', item: 'เปลี่ยนเหล็กยึดพิงฝุ่น R-L', standardHours: 1.5 },
    { id: 'kpi-401', category: 'หมวดหางลาก', item: 'เปลี่ยนกระบังเบรก R-L', standardHours: 3 },
    { id: 'kpi-402', category: 'หมวดหางลาก', item: 'เปลี่ยนเหล็กขาค้ำยัน R-L', standardHours: 3 },
    { id: 'kpi-403', category: 'หมวดหางลาก', item: 'เชื่อมขาค้ำยัน', standardHours: 3 },
    { id: 'kpi-404', category: 'หมวดหางลาก', item: 'เชื่อมยึด 1 จุด', standardHours: 1 },
    { id: 'kpi-405', category: 'หมวดหางลาก', item: 'ถังลมแบบมีหูยึด 25 ลิตร', standardHours: 3 },
    { id: 'kpi-406', category: 'หมวดหางลาก', item: 'ก๊อกปล่อยน้ำ', standardHours: 0.75 },
    { id: 'kpi-407', category: 'หมวดหางลาก', item: 'ก๊อกปล่อยน้ำแบบดึง', standardHours: 0.75 },
    { id: 'kpi-408', category: 'หมวดหางลาก', item: 'บอลวาวล์', standardHours: 1.5 },
    { id: 'kpi-409', category: 'หมวดหางลาก', item: 'กระบอกลมสั้น 50* 100', standardHours: 1.5 },
    { id: 'kpi-410', category: 'หมวดหางลาก', item: 'โซลินอยต์ Y 24 อุลตร้าแอร์', standardHours: 1.5 },
    { id: 'kpi-411', category: 'หมวดหางลาก', item: 'ตัวกรองฝุ่นเก็บเสียง', standardHours: 1.5 },
    { id: 'kpi-412', category: 'หมวดหางลาก', item: 'ชุดซ่อมกระบอกกลม', standardHours: 3 },
    { id: 'kpi-413', category: 'หมวดหางลาก', item: 'เปลี่ยน,ซ่อมสายลมไนล่อน', standardHours: 1.5 },
    { id: 'kpi-414', category: 'หมวดหางลาก', item: 'สายลมคอยล์สปริง เหลือง – แดง', standardHours: 1.5 },
    { id: 'kpi-415', category: 'หมวดหางลาก', item: 'โรลเลอร์ลูกเบี้ยวเบรก', standardHours: 1.5 },
    { id: 'kpi-416', category: 'หมวดหางลาก', item: 'โอริงแองเคอร์พิง', standardHours: 0.75 },
    { id: 'kpi-417', category: 'หมวดหางลาก', item: 'สปริงเกี่ยวก้ามเบรก (ใหญ่)', standardHours: 0.75 },
    { id: 'kpi-418', category: 'หมวดหางลาก', item: 'สปริงเกี่ยวก้ามเบรก (เล็ก)', standardHours: 0.75 },
    { id: 'kpi-419', category: 'หมวดหางลาก', item: 'ขาปรับตั้งเบรก', standardHours: 1.5 },
    { id: 'kpi-420', category: 'หมวดหางลาก', item: 'ฝาครอบบังฝุ่นเหล็ก', standardHours: 0.75 },
    { id: 'kpi-421', category: 'หมวดหางลาก', item: 'แกนน็อตล้อ+ปลอก', standardHours: 3 },
    { id: 'kpi-422', category: 'หมวดหางลาก', item: 'น็อตล้อปลอกใน', standardHours: 0.75 },
    { id: 'kpi-423', category: 'หมวดหางลาก', item: 'น็อตล้อปลอกนอก', standardHours: 0.75 },
    { id: 'kpi-424', category: 'หมวดหางลาก', item: 'ตัดต่อกันชนท้าย', standardHours: 3 },
    { id: 'kpi-425', category: 'หมวดหางลาก', item: 'ชุดซ่อมวาล์วเบรคหาง RE6', standardHours: 2.5 },
    { id: 'kpi-426', category: 'หมวดหางลาก', item: 'ปรับตั้งเบรคหางลาก', standardHours: 1 },
    { id: 'kpi-427', category: 'หมวดหางลาก', item: 'ปรับตั้งลูกปืนล้อ', standardHours: 1.25 },
    { id: 'kpi-428', category: 'หมวดPM', item: 'ถ่ายน้ำมันเครื่อง ตรวจเช็กช่วงล่าง ระบบเบรค ยาง', standardHours: 2 }
];