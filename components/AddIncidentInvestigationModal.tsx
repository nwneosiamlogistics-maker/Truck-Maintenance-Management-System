...
const AddIncidentInvestigationModal: React.FC<AddIncidentInvestigationModalProps> = ({
    ...
    const updateIncidentType = (field: keyof typeof formData.incidentType, value: any) => {
        setFormData(prev => ({
            ...prev,
            incidentType: {
                ...prev.incidentType!,
    ...
    const toggleRootCause = (category: keyof typeof formData.rootCauseAnalysis, item: string) => {
        setFormData(prev => {
            ...
            <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-6xl max-h-[95vh] overflow-hidden flex flex-col" onClick={e => e.stopPropagation()}>
                ...
                <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-red-50 to-orange-50 flex-shrink-0 flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 mt-1">Report No: {formData.reportNo}</p>
                    </div>
                                            ...
                                            {(() => {
                                                ...
                                                return (
                                                    <div className="relative">
                                                        ...
                                                        {(formData.whyWhyAnalysis?.roots?.length || 0) === 0 && (
                                                            <button type="button" onClick={handleAddRoot} className="ml-8 px-4 py-2 bg-slate-100 text-slate-500 text-sm rounded-lg hover:bg-slate-200 border border-dashed border-slate-300">
                        ...
                        <div className="space-y-8 animate-fade-in">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="p-4 bg-slate-50 rounded-xl space-y-3 border border-slate-100">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                            ...
                                            <input type="text" placeholder="ตำแหน่ง (Position)" className="form-input" />
                                            <input type="text" placeholder="บริษัท (Company)" className="form-input" />
                            ...
                            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                                ...
                                <div className="p-4 bg-slate-50 rounded-xl space-y-3 border border-slate-100">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                        <input type="text" placeholder="ชื่อ-นามสกุล (Name)" className="form-input" />
                                        <input type="text" placeholder="ตำแหน่ง (Position)" className="form-input" />
                                        <input type="text" placeholder="บริษัท (Company)" className="form-input" />
