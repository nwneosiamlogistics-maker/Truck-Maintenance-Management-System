...
const ReceiveFromPOModal: React.FC<ReceiveFromPOModalProps> = ({ isOpen, onClose, purchaseRequisitions, setPurchaseRequisitions, setStock, setTransactions }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 z-[102] flex justify-center items-center p-2 sm:p-4">
            <div className="bg-white rounded-2xl shadow-xl w-[95vw] max-w-2xl max-h-[90vh] flex flex-col" onClick={e => e.stopPropagation()}>
