...
const KPIDashboard: React.FC<KPIDashboardProps> = ({ repairs, plans, vehicles }) => {
    const kpiData = useMemo(() => {
        ...
        const repairsByVehicle = allRepairs.reduce((acc, r) => ({ ...acc, [r.licensePlate]: (acc[r.licensePlate] || 0) + 1 }), {} as Record<string, number>);
        ...
        const complianceByVehicle = planDetails.reduce((acc, plan) => {
