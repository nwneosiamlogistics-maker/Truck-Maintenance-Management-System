                    ...
                    <div className="flex gap-4 items-center">
                        <div className="flex gap-2">
                            ...
                            >
                                ...
                                <option value="maintenance_desc">ค่าซ่อมบำรุง (สูง-ต่ำ)</option>
                                <option value="maintenance_asc">ค่าซ่อมบำรุง (ต่ำ-สูง)</option>
                            </select>
                        </div>
                        <button
                    ...
                    <div className="flex justify-between items-start mb-4">
                        <div>
                            ...
                            <h3 className="text-3xl font-extrabold mt-2">
                                {(driverPerformances.reduce((sum, d) => sum + d.performance.safetyScore, 0) / drivers.length).toFixed(0)}
                            </h3>
                ...
                {filteredDrivers.map((driver, index) => (
                    ...
                    >
                        ...
                        <div className="p-4 bg-slate-50/50 border-t border-slate-100 flex gap-2">
                            <button className="flex-1 bg-white hover:bg-blue-50 text-slate-600 font-bold py-2 px-3 rounded-xl transition-all text-xs shadow-sm border border-slate-200 group-hover:border-blue-200 group-hover:text-blue-600">
                                รายละเอียด
                            </button>
                            <button className="px-3 bg-white hover:bg-amber-50 text-slate-600 hover:text-amber-600 font-bold py-2 rounded-xl transition-all shadow-sm border border-slate-200">
