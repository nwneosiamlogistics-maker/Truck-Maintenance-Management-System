                    ...
                    {plans.map((plan, index) => {
                        ...
                        return (
                            <tr key={plan.id} className="hover:bg-gray-50">
                                <td className="sticky left-0 bg-white z-10 p-2 border text-sm text-center">{index + 1}</td>
                                <td className="sticky left-12 bg-white z-10 p-2 border text-sm font-semibold">{plan.vehicleLicensePlate}</td>
